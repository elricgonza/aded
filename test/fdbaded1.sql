...
delete from gra;
insert into gra  (id, grado, niv_id) values (1, 'pre k', 1);
insert into gra  (id, grado, niv_id) values (2, 'kind', 1);

insert into gra  (id, grado, niv_id) values (3, '1ro Prim', 2);
insert into gra  (id, grado, niv_id) values (4, '2do Prim', 2);
insert into gra  (id, grado, niv_id) values (5, '3ro Prim', 2);
insert into gra  (id, grado, niv_id) values (6, '4to Prim', 2);
insert into gra  (id, grado, niv_id) values (7, '5to Prim', 2);
insert into gra  (id, grado, niv_id) values (8, '6to Prim', 2);

insert into gra  (id, grado, niv_id) values (9, '1ro Sec', 3);
insert into gra  (id, grado, niv_id) values (10, '2do Sec', 3);
insert into gra  (id, grado, niv_id) values (11, '3ro Sec', 3);
insert into gra  (id, grado, niv_id) values (12, '4to Sec', 3);
insert into gra  (id, grado, niv_id) values (13, '5to Sec', 3);
insert into gra  (id, grado, niv_id) values (14, '6to Sec', 3);

------
insert into gra  (id, grado, niv_id) values (15, '1ro. Inic', 4);
insert into gra  (id, grado, niv_id) values (16, '2do. Inic', 4);
insert into gra  (id, grado, niv_id) values (17, '1ro. Bas', 5);
insert into gra  (id, grado, niv_id) values (18, '2do. Bas', 5);
insert into gra  (id, grado, niv_id) values (19, '1ro. Interm', 6);
insert into gra  (id, grado, niv_id) values (20, '2do. Interm', 6);
insert into gra  (id, grado, niv_id) values (21, '3ro. Interm', 6);

--delete from grado where niv_id = 9


--------
--insert into mat(id, materia, gra_id) values (1, 'mat chit', 50);	--x ok
delete from mat;
...
insert into mat(id, materia, gra_id) values (7, 'lect', 3);
insert into mat(id, materia, gra_id) values (8, 'ed fis', 3);

insert into mat(id, materia, gra_id) values (9, 'escrit', 4);
insert into mat(id, materia, gra_id) values (10, 'lect', 4);
insert into mat(id, materia, gra_id) values (11, 'ed fis', 4);

insert into mat(id, materia, gra_id) values (12, 'escrit', 5);
insert into mat(id, materia, gra_id) values (13, 'lect', 5);
insert into mat(id, materia, gra_id) values (14, 'ed fis', 5);

insert into mat(id, materia, gra_id) values (16, 'escrit', 6);
insert into mat(id, materia, gra_id) values (17, 'lect', 6);
insert into mat(id, materia, gra_id) values (18, 'ed fis', 6);

insert into mat(id, materia, gra_id) values (19, 'escrit', 7);
insert into mat(id, materia, gra_id) values (20, 'lect', 7);
insert into mat(id, materia, gra_id) values (21, 'ed fis', 7);
insert into mat(id, materia, gra_id) values (22, 'music', 7);

insert into mat(id, materia, gra_id) values (23, 'escrit', 8);
insert into mat(id, materia, gra_id) values (24, 'lect', 8);
insert into mat(id, materia, gra_id) values (25, 'ed fis', 8);
insert into mat(id, materia, gra_id) values (26, 'music', 8);


--sec
insert into mat(id, materia, gra_id) values (27, 'mat', 9);
insert into mat(id, materia, gra_id) values (28, 'lite', 9);
insert into mat(id, materia, gra_id) values (29, 'est soc', 9);
insert into mat(id, materia, gra_id) values (30, 'music', 9);

insert into mat(id, materia, gra_id) values (31, 'mat', 10);
insert into mat(id, materia, gra_id) values (32, 'lite', 10);
insert into mat(id, materia, gra_id) values (33, 'est soc', 10);
insert into mat(id, materia, gra_id) values (34, 'music', 10);

insert into mat(id, materia, gra_id) values (35, 'mat', 11);
insert into mat(id, materia, gra_id) values (36, 'lite', 11);
insert into mat(id, materia, gra_id) values (37, 'est soc', 11);
insert into mat(id, materia, gra_id) values (38, 'music', 11);

insert into mat(id, materia, gra_id) values (39, 'mat', 12);
insert into mat(id, materia, gra_id) values (40, 'lite', 12);
insert into mat(id, materia, gra_id) values (41, 'est soc', 12);
insert into mat(id, materia, gra_id) values (42, 'music', 12);

insert into mat(id, materia, gra_id) values (43, 'mat', 13);
insert into mat(id, materia, gra_id) values (44, 'lite', 13);
insert into mat(id, materia, gra_id) values (45, 'est soc', 13);
insert into mat(id, materia, gra_id) values (46, 'music', 13);
insert into mat(id, materia, gra_id) values (47, 'filos', 13);

insert into mat(id, materia, gra_id) values (48, 'mat', 14);
insert into mat(id, materia, gra_id) values (49, 'lite', 14);
insert into mat(id, materia, gra_id) values (50, 'est soc', 14);
insert into mat(id, materia, gra_id) values (51, 'music', 14);
insert into mat(id, materia, gra_id) values (52, 'filos', 14);
...
ALTER TABLE ONLY public.grado
   ADD CONSTRAINT grado_niv_id_fkey FOREIGN KEY (niv_id) 
   REFERENCES public.nivel(id) ON UPDATE CASCADE ON DELETE RESTRICT;

ALTER TABLE ONLY public.materia
   ADD CONSTRAINT materia_gra_id_fkey FOREIGN KEY (gra_id) 
