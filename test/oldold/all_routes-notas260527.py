...
def index():
    ...
    # Calcular qué notas puede editar el usuario actual
    notas_editables = {n.id for n in pagination.items if _puede_editar_nota(n)}
    ...
    return render_template('nota/index.html',
                           ...
                           profesor=profesor,
                           notas_editables=notas_editables)
